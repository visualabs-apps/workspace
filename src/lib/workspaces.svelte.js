...
function createWorkspaceStore() {
    ...
    if (storedWorkspaces.length === 0) {
        const defaultWorkspace = {
            ...
            icon: cookieSvg,
            color: { name: 'custom', value: '#4A90E2', hex: '#4A90E2' },
            apps: [],
            createdAt: Date.now()
        };
    ...
    return {
        ...
        deleteWorkspace(id) {
            return this.removeWorkspace(id);
        },
